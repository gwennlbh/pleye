...
export const runs = pgTable(
	'runs',
	{
		...
		githubJobName: text('github_job_name').notNull(),
		githubRunId: bigint('github_run_id', { mode: 'number' }).notNull(),
		githubRunName: text('github_run_name').notNull(),
		baseDirectory: text('base_directory'),
		commitSha: text('commit_sha').notNull(),
		commitTitle: text('commit_title').notNull(),
		commitDescription: text('commit_description').notNull(),
